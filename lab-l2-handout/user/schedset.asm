...
int main(int argc, char *argv[])
{
  ...
  12:	80250513          	addi	a0,a0,-2046 # 810 <malloc+0xee>
  ...
  36:	352080e7          	jalr	850(ra) # 384 <schedset>
    exit(0);
  3a:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	46850513          	addi	a0,a0,1128 # 838 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	39cb8b93          	addi	s7,s7,924 # 838 <digits>
 ...
 5e0:	25490913          	addi	s2,s2,596 # 830 <malloc+0x10e>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7fa:	b66080e7          	jalr	-1178(ra) # 35c <sbrk>
  if(p == (char*)-1)
