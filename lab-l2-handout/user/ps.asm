...
int main(int argc, char *argv[])
{
  ...
  20:	6905                	lui	s2,0x1
  22:	91490913          	addi	s2,s2,-1772 # 914 <digits+0xdc>
  ...
  2c:	7f898993          	addi	s3,s3,2040 # 820 <malloc+0xea>
        if (procs[i].state == UNUSED)
  ...
  42:	63a080e7          	jalr	1594(ra) # 678 <printf>
    for (int i = 0; i < 64; i++)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	45450513          	addi	a0,a0,1108 # 838 <digits>
 3ec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5f4:	24090913          	addi	s2,s2,576 # 830 <malloc+0xfa>
        while(*s != 0){
