...
int getcmd(char *buf, int nbuf)
{
    ...
    write(2, "$ ", 2);
      ...
      16:	3ce58593          	addi	a1,a1,974 # 13e0 <malloc+0xe8>
      1a:	4509                	li	a0,2
...
void panic(char *s)
{
    ...
    fprintf(2, "%s\n", s);
      ...
      64:	38858593          	addi	a1,a1,904 # 13e8 <malloc+0xf0>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	1a2080e7          	jalr	418(ra) # 120c <fprintf>
    exit(1);
      72:	4505                	li	a0,1
...
int fork1(void)
{
    ...
    return pid;
      ...
      9e:	35650513          	addi	a0,a0,854 # 13f0 <malloc+0xf8>
...
00000000000000aa <runcmd>:
{
    ...
    switch (cmd->type)
      ...
      ca:	43e70713          	addi	a4,a4,1086 # 1504 <malloc+0x20c>
      ...
      e4:	31850513          	addi	a0,a0,792 # 13f8 <malloc+0x100>
     ...
     106:	2fe58593          	addi	a1,a1,766 # 1400 <malloc+0x108>
     10a:	4509                	li	a0,2
    ...
    exit(0);
     ...
     152:	2c258593          	addi	a1,a1,706 # 1410 <malloc+0x118>
     156:	4509                	li	a0,2
     ...
     1e8:	23c50513          	addi	a0,a0,572 # 1420 <malloc+0x128>
...
execcmd(void)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     28a:	072080e7          	jalr	114(ra) # 12f8 <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     2d4:	028080e7          	jalr	40(ra) # 12f8 <malloc>
     2d8:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     32e:	fce080e7          	jalr	-50(ra) # 12f8 <malloc>
     332:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     374:	f88080e7          	jalr	-120(ra) # 12f8 <malloc>
     378:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
    ...
    cmd = malloc(sizeof(*cmd));
     ...
     3b6:	f46080e7          	jalr	-186(ra) # 12f8 <malloc>
     3ba:	84aa                	mv	s1,a0
    memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
    ...
    while (peek(ps, es, "<>"))
     ...
     5a8:	ea4b8b93          	addi	s7,s7,-348 # 1448 <malloc+0x150>
    {
    ...
    while (peek(ps, es, "<>"))
     ...
     5ba:	e7250513          	addi	a0,a0,-398 # 1428 <malloc+0x130>
...
parseexec(char **ps, char *es)
{
    ...
    if (peek(ps, es, "("))
     ...
     6a2:	db260613          	addi	a2,a2,-590 # 1450 <malloc+0x158>
    ...
    while (!peek(ps, es, "|)&;"))
     ...
     6d2:	da2b0b13          	addi	s6,s6,-606 # 1470 <malloc+0x178>
    {
    ...
    return ret;
     ...
     70c:	d5050513          	addi	a0,a0,-688 # 1458 <malloc+0x160>
    ...
    while (!peek(ps, es, "|)&;"))
     ...
     76e:	cf650513          	addi	a0,a0,-778 # 1460 <malloc+0x168>
...
0000000000000788 <parsepipe>:
{
    ...
    if (peek(ps, es, "|"))
     ...
     7a8:	cd460613          	addi	a2,a2,-812 # 1478 <malloc+0x180>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
    ...
    while (peek(ps, es, "&"))
     ...
     818:	c6ca0a13          	addi	s4,s4,-916 # 1480 <malloc+0x188>
     81c:	8652                	mv	a2,s4
     81e:	85ce                	mv	a1,s3
     820:	854a                	mv	a0,s2
    ...
    if (peek(ps, es, ";"))
     ...
     84e:	c3e60613          	addi	a2,a2,-962 # 1488 <malloc+0x190>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
    ...
    if (!peek(ps, es, "("))
     ...
     8b4:	ba060613          	addi	a2,a2,-1120 # 1450 <malloc+0x158>
    ...
    if (!peek(ps, es, ")"))
     ...
     8e4:	bc060613          	addi	a2,a2,-1088 # 14a0 <malloc+0x1a8>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
    ...
    cmd = parseredirs(cmd, ps, es);
     ...
     926:	b6e50513          	addi	a0,a0,-1170 # 1490 <malloc+0x198>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
        panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	b7650513          	addi	a0,a0,-1162 # 14a8 <malloc+0x1b0>
...
nulterminate(struct cmd *cmd)
{
    ...
    switch (cmd->type)
     ...
     962:	bbe70713          	addi	a4,a4,-1090 # 151c <malloc+0x224>
...
00000000000009da <parsecmd>:
{
    ...
    peek(&s, es, "");
     ...
     a0e:	ab660613          	addi	a2,a2,-1354 # 14c0 <malloc+0x1c8>
     a12:	85a6                	mv	a1,s1
    ...
    nulterminate(cmd);
     ...
     a44:	a8858593          	addi	a1,a1,-1400 # 14c8 <malloc+0x1d0>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	7c2080e7          	jalr	1986(ra) # 120c <fprintf>
        panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	a0650513          	addi	a0,a0,-1530 # 1458 <malloc+0x160>
...
0000000000000a62 <parse_buffer>:
{
    ...
    if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ')
     ...
     af0:	9ec58593          	addi	a1,a1,-1556 # 14d8 <malloc+0x1e0>
     af4:	4509                	li	a0,2
     af6:	00000097          	auipc	ra,0x0
     afa:	716080e7          	jalr	1814(ra) # 120c <fprintf>
...
0000000000000b34 <main>:
{
    ...
    while ((fd = open("console", O_RDWR)) >= 0)
     ...
     b4a:	9a248493          	addi	s1,s1,-1630 # 14e8 <malloc+0x1f0>
     b4e:	4589                	li	a1,2
     b50:	8526                	mv	a0,s1
    ...
    while (getcmd(buf, sizeof(buf)) >= 0)
     ...
     b72:	4b248493          	addi	s1,s1,1202 # 2020 <buf.1159>
    if (argc == 2)
     ...
     b98:	48c58593          	addi	a1,a1,1164 # 2020 <buf.1159>
     b9c:	00000097          	auipc	ra,0x0
     ba0:	326080e7          	jalr	806(ra) # ec2 <read>
            parse_buffer(buf);
     ba4:	00001497          	auipc	s1,0x1
     ba8:	47c48493          	addi	s1,s1,1148 # 2020 <buf.1159>
     bac:	8526                	mv	a0,s1
     ...
     bde:	91650513          	addi	a0,a0,-1770 # 14f0 <malloc+0x1f8>
     be2:	00000097          	auipc	ra,0x0
     be6:	658080e7          	jalr	1624(ra) # 123a <printf>
            exit(1);
     bea:	4505                	li	a0,1
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f78:	f56080e7          	jalr	-170(ra) # eca <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     faa:	59a50513          	addi	a0,a0,1434 # 1540 <digits>
     fae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1076:	4ceb8b93          	addi	s7,s7,1230 # 1540 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    11b6:	38690913          	addi	s2,s2,902 # 1538 <malloc+0x240>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    1354:	d4878793          	addi	a5,a5,-696 # 2098 <base>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    13d0:	b66080e7          	jalr	-1178(ra) # f32 <sbrk>
  if(p == (char*)-1)
