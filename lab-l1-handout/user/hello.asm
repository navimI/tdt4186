...
hello(int n, char *user)
{
   ...
   6:	0800                	addi	s0,sp,16
    if(n == 0)
   8:	ed09                	bnez	a0,22 <hello+0x22>
    {
        printf("Hello World\n");
   a:	00001517          	auipc	a0,0x1
   e:	82650513          	addi	a0,a0,-2010 # 830 <malloc+0xf2>
  12:	00000097          	auipc	ra,0x0
  16:	66e080e7          	jalr	1646(ra) # 680 <printf>
  ...
  26:	81e50513          	addi	a0,a0,-2018 # 840 <malloc+0x102>
  2a:	00000097          	auipc	ra,0x0
  2e:	656080e7          	jalr	1622(ra) # 680 <printf>
}
  32:	b7e5                	j	1a <hello+0x1a>
...
main(int argc, char *argv[])
{
  ...
  3a:	0800                	addi	s0,sp,16
    ...
    if(argc < 2){
  3c:	4785                	li	a5,1
  3e:	02a7d063          	bge	a5,a0,5e <main+0x2a>
        printf("Hello %s, nice to meet you!\n", user);
  42:	658c                	ld	a1,8(a1)
  44:	00000517          	auipc	a0,0x0
  48:	7fc50513          	addi	a0,a0,2044 # 840 <malloc+0x102>
  4c:	00000097          	auipc	ra,0x0
  50:	634080e7          	jalr	1588(ra) # 680 <printf>
        hello(0,"");
    }
    else{
        hello(1,argv[1]);
  ...
  5a:	2aa080e7          	jalr	682(ra) # 300 <exit>
        printf("Hello World\n");
  5e:	00000517          	auipc	a0,0x0
  62:	7d250513          	addi	a0,a0,2002 # 830 <malloc+0xf2>
  66:	00000097          	auipc	ra,0x0
  6a:	61a080e7          	jalr	1562(ra) # 680 <printf>
}
  6e:	b7dd                	j	54 <main+0x20>
...
_main()
{
  ...
  7c:	fbc080e7          	jalr	-68(ra) # 34 <main>
  exit(0);
  80:	4501                	li	a0,0
